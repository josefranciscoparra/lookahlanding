...
export const features3 = [
  {
    id: 1,
    imgSrc: "/assets/images/template/feature-01.svg",
    altText: "Sube tu modelo con facilidad",
    step: "01.",
    title: "Sube tu modelo con facilidad",
    description: `Comienza cargando fotos de tus modelos con fondos neutros. Nuestra IA está optimizada para reconocer poses y características faciales, garantizando resultados precisos. Acepta múltiples formatos de imagen y las procesa en segundos para que puedas empezar rápidamente.`,
    testimonial: {
      quote: `"Antes tardábamos horas en sesiones fotográficas. Ahora con Lookah podemos probar múltiples outfits en minutos y enfocarnos en la creatividad."`,
      imgSrc: "/assets/images/avatars/01.png",
      name: "María González",
      role: "Directora de Moda",
    },
  },
  {
    id: 2,
    imgSrc: "/assets/images/template/feature-02.svg",
    altText: "Carga tus prendas de vestir",
    step: "02.",
    title: "Carga tus prendas de vestir",
    description: `Sube fotos de las prendas que deseas probar: camisas, pantalones, vestidos, chaquetas y más. Organiza tu biblioteca de prendas por categorías y accede a ellas cuando quieras. La IA reconoce automáticamente el tipo de prenda y sus características para aplicarlas de forma natural.`,
    link: {
      href: "#",
      text: "Ver categorías disponibles",
    },
    testimonial: {
      quote: `"La forma en que Lookah organiza las prendas es increíble. Puedo crear múltiples looks para mis clientes en una fracción del tiempo."`,
      imgSrc: "/assets/images/avatars/02.png",
      name: "Carlos Martínez",
      role: "Estilista Personal",
    },
  },
  {
    id: 3,
    imgSrc: "/assets/images/template/feature-03.svg",
    altText: "Ajusta los parámetros perfectos",
    step: "03.",
    title: "Ajusta los parámetros perfectos",
    description: `Personaliza cada detalle: elige el estilo (casual, formal, urbano), selecciona la temporada, define si quieres cuerpo completo o medio cuerpo, y ajusta la iluminación. Nuestro sistema de configuración avanzada te da control total sobre el resultado final para que coincida exactamente con tu visión.`,
    testimonial: {
      quote: `"Los controles de personalización son muy intuitivos. Puedo crear exactamente el look que tengo en mente sin complicaciones técnicas."`,
  ...
  },
  {
    ...
    altText: "Disfruta de resultados profesionales",
    step: "04.",
    title: "Disfruta de resultados profesionales",
    description: `En segundos, obtén imágenes de alta calidad listas para usar. Descarga tus creaciones, compártelas con tu equipo o clientes, y guárdalas en tu galería personal. Cada resultado mantiene las características faciales originales mientras aplica las prendas de manera realista y profesional.`,
    testimonial: {
      quote: `"La calidad de las imágenes generadas es impresionante. Las uso directamente en mis catálogos sin necesidad de edición adicional."`,
